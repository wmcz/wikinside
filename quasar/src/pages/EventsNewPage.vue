<template>
  <q-page class="flex flex-center">
    ...
    >
      ...
      <TagSelect ref="tagSelect" url="tags/event-tags" label="tag.event"/>
      <TagSelect ref="userTagSelect" url="tags/user-tags" label="tag.user"/>
    ...
    onSubmit() {
      api
        .post('/events', {
          name: this.name,
          id: null,
          tagIds: this.$refs.tagSelect.selected === null ? [] : this.$refs.tagSelect.selected,
          userTagIds: this.$refs.userTagSelect.selected === null ? [] : this.$refs.userTagSelect.selected,
