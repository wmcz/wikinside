...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/user/tag/:id',  component: () => import('pages/TagDetailPage.vue'), name: 'usertag', props: {elemtype: 'user'} },
      ...
      { path: '/event/tag/:id', component: () => import('pages/TagDetailPage.vue'), name: 'eventtag', props: {elemtype:'event'}},
