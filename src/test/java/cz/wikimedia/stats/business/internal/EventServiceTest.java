...
class EventServiceTest {
    ...
    void update() {
        ...
        Event event1 = new Event(1L, null, "one", null, LocalDate.of(2000, 1, 1), LocalDate.of(2000, 12, 31), new HashSet<>(Set.of(user1, user2)), new HashSet<>(Set.of(project1)), new HashSet<>(revs));
        Event event2 = new Event(2L, null, "one", null, LocalDate.of(2000, 1, 1), LocalDate.of(2000, 12, 31), new HashSet<>(Set.of(user2, user3)), new HashSet<>(Set.of(project2)), new HashSet<>(revs));
        Event event3 = new Event(3L, null, "one", null, LocalDate.of(1999, 1, 1), LocalDate.of(2001, 12, 31), new HashSet<>(Set.of(user1, user2, user3)), new HashSet<>(Set.of(project1, project2)), new HashSet<>(revs));
        Event event4 = new Event(4L, null, "one", "##", LocalDate.of(1999, 1, 1), LocalDate.of(1999, 12, 31), new HashSet<>(Set.of(user1, user2, user3)), new HashSet<>(Set.of(project1)), new HashSet<>(revs));
