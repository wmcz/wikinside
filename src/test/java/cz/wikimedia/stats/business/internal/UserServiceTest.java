...
class UserServiceTest {
    ...
    @BeforeEach
    void setUp() {
        Event event1 = new Event(1001L, null, "one", null, null, null, new HashSet<>(), null, null);
        Event event2 = new Event(1002L, null, "two", null, null, null, new HashSet<>(), null, null);
    ...
    void create() {
        ...
        Assertions.assertTrue(service.create(new User(6L, 6L, "six",  Instant.EPOCH, new HashSet<>(), new HashSet<>(List.of(new Event(1001L, null, null, null, null, null, new HashSet<>(), null, null))))).isPresent());
        Mockito.verify(repository, Mockito.atLeastOnce()).save(new User(6L, "six"));
        Mockito.verify(eventRepository, Mockito.atLeastOnce()).save(new Event(1001L, null, null, null, null, null, null, null, null));
    }
    ...
    void update() {
        ...
        Mockito.verify(eventRepository, Mockito.atLeastOnce()).save(new Event(1001L, null, null, null, null, null, null, null, null));
        Mockito.verify(eventRepository, Mockito.atLeastOnce()).save(new Event(1002L, null, null, null, null, null, null, null, null));
    }
